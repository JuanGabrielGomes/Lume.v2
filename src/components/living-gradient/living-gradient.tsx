...
const blobs = [
  {
    className:
      "left-[-12rem] top-[-8rem] h-[24rem] w-[24rem] bg-[radial-gradient(circle,_rgba(232,174,107,0.28),_rgba(232,174,107,0)_70%)] md:h-[40rem] md:w-[40rem]",
    animate: {
      x: [0, 110, 40, -20, 0],
      y: [0, 70, 130, 40, 0],
  ...
  {
    className:
      "right-[-16rem] top-[8rem] h-[20rem] w-[20rem] bg-[radial-gradient(circle,_rgba(243,240,235,0.18),_rgba(243,240,235,0)_72%)] md:h-[36rem] md:w-[36rem]",
    animate: {
      x: [0, -90, -25, -120, 0],
      y: [0, 110, -35, 30, 0],
  ...
  {
    className:
      "bottom-[-14rem] left-1/2 h-[22rem] w-[22rem] -translate-x-1/2 bg-[radial-gradient(circle,_rgba(232,174,107,0.18),_rgba(232,174,107,0)_70%)] md:h-[38rem] md:w-[38rem]",
    animate: {
      x: [0, -70, 85, 20, 0],
      y: [0, -100, -20, -75, 0],
...
export function LivingGradient() {
  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-x-0 top-0 h-[24rem] bg-[radial-gradient(circle_at_top,_rgba(255,241,220,0.08),_transparent_55%)] blur-[100px] md:h-[32rem] md:blur-[120px]" />
      <div className="absolute bottom-[-8rem] left-1/2 h-[18rem] w-[36rem] -translate-x-1/2 bg-[radial-gradient(circle,_rgba(255,241,220,0.06),_transparent_62%)] blur-[100px] md:h-[28rem] md:w-[72rem] md:blur-[150px]" />
